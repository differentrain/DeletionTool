...
namespace YYProject.AdvancedDeletion
{
    ...
    {
        public Win32FileAttributeData FileAttributes;
    ...
    internal enum GetFileExInfoLevels
    {
    ...
    [Flags]
    internal enum DuplicateOptions : UInt32
    {
        None = 0,
        /// <summary>
    ...
    internal enum ObjectInfoamtionClass : Int32
    {
    ...
    internal struct RmProcessInfo
    {
        ...
        public Int32 TSSessionId;
        public Boolean bRestartable;
        public Int32 Size => Marshal.SizeOf(typeof(RmProcessInfo));
    }
    [Flags]
